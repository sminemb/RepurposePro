...
export function FinalCta({ isAuthenticated }: SessionAwareProps) {
  return (
    <section className="relative isolate overflow-hidden border-t border-white/8 bg-rp-bg-deep">
      <div className="pointer-events-none absolute inset-y-0 right-0 -z-10 w-1/2 bg-[radial-gradient(circle_at_right,rgb(123_97_255_/_0.15),transparent_65%)]" />
